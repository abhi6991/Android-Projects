package com.example.abhishek.loginapp;
...
public class MainActivity extends Activity implements View.OnClickListener {
                ...
                if (session.isOpened()) {
                    ...
                    for (int i = 0; i < session.getPermissions().size(); i++) {
                        if (session.getPermissions().get(i).contains("email")) {
                            ...
                            DownloadManager.Request.newMeRequest(session,
                ...
                if (session.isOpened()) {
                    ...
                    for (int i = 0; i < session.getPermissions().size(); i++) {
                        if (session.getPermissions().get(i)
                            ...
                            DownloadManager.Request.newMyFriendsRequest(session,
    ...
    private void getPermissionFromFacebook() {
        ...
        PackageInstaller.Session.getActiveSession().requestNewReadPermissions(
